...
//                    return;
            ...
            function gotoNext() {
                ...
                var tempNr = currNr + 1;
                console.info('gotoNext tempNr - ',tempNr, cgallery)
...
//                                console.info(o.responsive_ratio);
            ...
            function setup_local_video(pargs){
                ...
                if(( (1) && autoplay=='on' && o.autoplay_on_mobile_too_with_video_muted=='on')||o.defaultvolume===0){
                    aux+= ' muted';
                ...
                if (o.type == 'normal' || o.type == 'audio'|| o.type == 'dash'){
                    ...
                    try{
                        ...
                        try{
                            ...
                            if(o.call_from=='autoplay - on' && is_mobile() && window.dzsvg_had_user_action==false){
                                video.muted = true;
                            ...
                            console.info('play did not go through')
